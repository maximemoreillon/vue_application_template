(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue-material-design-icons/Backburger.vue'), require('vue-material-design-icons/Menu.vue')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vue-material-design-icons/Backburger.vue', 'vue-material-design-icons/Menu.vue'], factory) :
  (global = global || self, factory(global.AppTemplate = {}, global.BackburgerIcon, global.MenuIcon));
}(this, (function (exports, BackburgerIcon, MenuIcon) { 'use strict';
  ...
  var __vue_render__ = function() {
    ...
    return _c("div", { staticClass: "application_wrapper" }, [
      _c(
        "header",
        [
          _vm.navigation.length > 0 && _vm.navigation_open
            ? _c("backburger-icon", {
                on: {
          ...
          _vm._v(" "),
          !_vm.noLoginControls && _vm.logged_in
            ? _c("span", {
                staticClass: "mdi mdi-logout aligned_right button",
                on: {
                  click: function($event) {
                    return _vm.logout()
                  }
