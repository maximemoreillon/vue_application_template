(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue-material-design-icons/Backburger.vue'), require('vue-material-design-icons/Menu.vue'), require('vue-material-design-icons/Login.vue'), require('vue-material-design-icons/Logout.vue')) :
  typeof define === 'function' && define.amd ? define(['exports', 'vue-material-design-icons/Backburger.vue', 'vue-material-design-icons/Menu.vue', 'vue-material-design-icons/Login.vue', 'vue-material-design-icons/Logout.vue'], factory) :
  (global = global || self, factory(global.AppTemplate = {}, global.BackburgerIcon, global.MenuIcon, global.LoginIcon, global.LogoutIcon));
}(this, (function (exports, BackburgerIcon, MenuIcon, LoginIcon, LogoutIcon) { 'use strict';

  BackburgerIcon = BackburgerIcon && BackburgerIcon.hasOwnProperty('default') ? BackburgerIcon['default'] : BackburgerIcon;
  MenuIcon = MenuIcon && MenuIcon.hasOwnProperty('default') ? MenuIcon['default'] : MenuIcon;
  LoginIcon = LoginIcon && LoginIcon.hasOwnProperty('default') ? LoginIcon['default'] : LoginIcon;
  LogoutIcon = LogoutIcon && LogoutIcon.hasOwnProperty('default') ? LogoutIcon['default'] : LogoutIcon;
