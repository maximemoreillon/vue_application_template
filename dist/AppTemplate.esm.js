  ...
  return _c("div", { staticClass: "application_wrapper" }, [
    _c(
      ...
      [
        ...
        _vm._v(" "),
        !_vm.noLoginControls &&
        !!_vm.authenticationApiUrl &&
        !!_vm.authenticationFrontUrl
          ? _c("LoginStatus", {
